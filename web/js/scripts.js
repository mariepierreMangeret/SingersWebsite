...
$(function() {
    ...
    wind.on("scroll",function () {
        ...
        if(bodyScroll > 100){
            ...
            logo.attr('src', '/SingersWebsite/web/img/logo-dark.png');

        }else{

            navbar.removeClass("nav-scroll");
            logo.attr('src', '/SingersWebsite/web/img/logo-light.png');
            navbloglogo.attr('src', '/SingersWebsite/web/img/logo-dark.png');
        }
    });
